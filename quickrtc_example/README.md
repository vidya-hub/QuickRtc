...
A complete working example demonstrating how to build a video conferencing application using `quickrtc_client` and `quickrtc_server`.
...
- **🔌 Dependency Injection**: The server uses your existing HTTP/HTTPS and Socket.IO servers.
- **🔐 HTTPS Support**: Comes with self-signed certificates for local development.
- **📱 Responsive UI**: A basic UI that works on desktop and mobile.
- **🎥 Full Media Support**: Audio, video, and screen sharing.
- **👥 Multi-Participant**: Supports multiple participants.
...
│   └── quickrtc_client/      # Client library (symlinked)
│       └── client.js
├── certs/
...
- `quickrtc_types` - Shared TypeScript types
- `quickrtc_server` - Server package
- `quickrtc_client` - Client package
- `quickrtc_example` - This example app
...
- [Client API Documentation](../quickrtc_client/README.md)
- [Server API Documentation](../quickrtc_server/README.md)
